...
public class XML {
    ...
    public static String MontaMensagem(String cmdEx) {
        ...
        MsgXMLArray[IdNv0][IdNv1][6][0] = "TBAT1";		MsgXMLArray[IdNv0][IdNv1][6][1] = cc1.tempBat + " C";
        ...
        MsgXMLArray[IdNv0][IdNv1][12][0] = "TBAT2";		MsgXMLArray[IdNv0][IdNv1][12][1] = cc2.tempBat + " C";
